  ...
  return (
    <div>
      <div className='text-white bg-black flex lg:justify-evenly justify-start lg:flex-row flex-wrap md:flex-cols py-3'>
        <div className='flex lgmx-4  mx-1 text-2xl card ' data-aos="fade-up">
        ...
        <div className='flex lg:mx-4 mx-1 my-2 text-2xl card' data-aos="fade-up">
        ...
        <div className='flex lg:mx-4 mx-2 my-2 text-2xl card ' data-aos="fade-up">
